...
// @ts-nocheck 
/*
 * This file exports the `CattleListing` model and its related types.
 *
...
export type GetCattleListingAggregateType<T extends CattleListingAggregateArgs> = {
      [P in keyof T & keyof AggregateCattleListing]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCattleListing[P]>
    : Prisma.GetScalarType<T[P], AggregateCattleListing[P]>
}
...
export type GetCattleListingGroupByPayload<T extends CattleListingGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CattleListingGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CattleListingGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CattleListingGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CattleListingGroupByOutputType[P]>
      }
    >
  >
...
export type CattleListingCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<CattleListingFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CattleListingDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['CattleListing'], meta: { name: 'CattleListing' } }
  /**
   ...
   * })
  **/
  count<T extends CattleListingCountArgs>(
    args?: Prisma.Subset<T, CattleListingCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CattleListingCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends CattleListingGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, CattleListingGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCattleListingGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
