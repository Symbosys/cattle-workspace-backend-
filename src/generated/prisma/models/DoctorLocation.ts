...
// @ts-nocheck 
/*
 * This file exports the `DoctorLocation` model and its related types.
 *
...
export type GetDoctorLocationAggregateType<T extends DoctorLocationAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDoctorLocation[P]>
    : Prisma.GetScalarType<T[P], AggregateDoctorLocation[P]>
}
...
export type GetDoctorLocationGroupByPayload<T extends DoctorLocationGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DoctorLocationGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DoctorLocationGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DoctorLocationGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DoctorLocationGroupByOutputType[P]>
      }
    >
  >
...
export type DoctorLocationCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface DoctorLocationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends DoctorLocationCountArgs>(
    args?: Prisma.Subset<T, DoctorLocationCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DoctorLocationCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, DoctorLocationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDoctorLocationGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
