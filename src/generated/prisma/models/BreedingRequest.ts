...
// @ts-nocheck 
/*
 * This file exports the `BreedingRequest` model and its related types.
 *
...
export type GetBreedingRequestAggregateType<T extends BreedingRequestAggregateArgs> = {
      [P in keyof T & keyof AggregateBreedingRequest]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBreedingRequest[P]>
    : Prisma.GetScalarType<T[P], AggregateBreedingRequest[P]>
}
...
export type GetBreedingRequestGroupByPayload<T extends BreedingRequestGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BreedingRequestGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BreedingRequestGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BreedingRequestGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BreedingRequestGroupByOutputType[P]>
      }
    >
  >
...
export type BreedingRequestCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<BreedingRequestFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BreedingRequestDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['BreedingRequest'], meta: { name: 'BreedingRequest' } }
  /**
   ...
   * })
  **/
  count<T extends BreedingRequestCountArgs>(
    args?: Prisma.Subset<T, BreedingRequestCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BreedingRequestCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends BreedingRequestGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, BreedingRequestGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBreedingRequestGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
