...
// @ts-nocheck 
/*
 * This file exports the `BrandLocation` model and its related types.
 *
...
export type GetBrandLocationAggregateType<T extends BrandLocationAggregateArgs> = {
      [P in keyof T & keyof AggregateBrandLocation]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBrandLocation[P]>
    : Prisma.GetScalarType<T[P], AggregateBrandLocation[P]>
}
...
export type GetBrandLocationGroupByPayload<T extends BrandLocationGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BrandLocationGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BrandLocationGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BrandLocationGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BrandLocationGroupByOutputType[P]>
      }
    >
  >
...
export type BrandLocationCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<BrandLocationFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BrandLocationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['BrandLocation'], meta: { name: 'BrandLocation' } }
  /**
   ...
   * })
  **/
  count<T extends BrandLocationCountArgs>(
    args?: Prisma.Subset<T, BrandLocationCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BrandLocationCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends BrandLocationGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, BrandLocationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBrandLocationGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
