...
export class BrandsService {
  public static async registerBrand(
    userId: string,
    brandData: {
      brandName: string;
      slug: string;
    ...
    return await db.$transaction(async (tx) => {
      ...
      let city = await BrandsRepository.findCityByNameAndState(
  ...
  public static async getBrandsNearby(
    lat: number,
    lng: number,
    radiusKm: number,
    page: number,
  ...
  public static async updateBrand(
    ...
    return await db.$transaction(async (tx) => {
      ...
      if (locationData) {
        ...
        if (existingLoc) {
          await BrandsRepository.updateBrandLocation(
            existingLoc.id,
            {
              latitude: locationData.latitude ?? null,
              longitude: locationData.longitude ?? null,
      ...
      const updateData: Prisma.BrandProfileUncheckedUpdateInput = {};
      if (brandData.brandName !== undefined) updateData.brandName = brandData.brandName;
      if (brandData.slug !== undefined) updateData.slug = brandData.slug;
      if (brandData.description !== undefined) updateData.description = brandData.description;
      if (brandData.logoUrl !== undefined) updateData.logoUrl = brandData.logoUrl;
      if (brandData.bannerUrl !== undefined) updateData.bannerUrl = brandData.bannerUrl;
      if (brandData.contactEmail !== undefined) updateData.contactEmail = brandData.contactEmail;
      if (brandData.contactPhone !== undefined) updateData.contactPhone = brandData.contactPhone;
      if (brandData.address !== undefined) updateData.address = brandData.address;
      if (brandData.gstNumber !== undefined) updateData.gstNumber = brandData.gstNumber;
      if (brandData.isActive !== undefined) updateData.isActive = brandData.isActive;
