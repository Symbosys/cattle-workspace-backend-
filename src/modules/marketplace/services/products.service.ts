...
export class ProductsService {
  ...
  public static async createProduct(
    ...
    data: {
      ...
      images?: { url: string; public_id: string }[] | null | undefined;
      attributes?: Record<string, any> | null | undefined;
      // Top-level fields for simple product default variant
      ...
      variants?: {
        ...
        compareAtPrice?: number | null | undefined;
        stock?: number | undefined;
        imageUrl?: { url: string; public_id: string } | null | undefined;
    ...
    return await db.$transaction(async (tx) => {
      ...
      const productInput: Prisma.MarketplaceProductUncheckedCreateInput = {
  ...
  public static async updateProduct(
    ...
    return await db.$transaction(async (tx) => {
      ...
      if (data.images !== undefined) {
        ...
        const newPublicIds = new Set(newImages.map((img: any) => img.public_id).filter(Boolean));
      ...
      // 6. Perform update
      const updateData: Prisma.MarketplaceProductUncheckedUpdateInput = {};
      ...
      if (data.attributes !== undefined) updateData.attributes = data.attributes as any;
   ...
   */
  public static async deleteProduct(ownerId: string, id: string) {
    return await db.$transaction(async (tx) => {
      ...
      for (const variant of product.variants) {
        const variantImg = variant.imageUrl as any;
