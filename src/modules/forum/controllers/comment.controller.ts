...
export const createQuestionComment = asyncHandler(async (req, res, next) => {
  ...
  const comment = await CommentService.createQuestionComment(
    req.user.id,
...
export const createAnswerComment = asyncHandler(async (req, res, next) => {
  ...
  const comment = await CommentService.createAnswerComment(
    req.user.id,
    answerId as string,
    validated,
  );
...
export const listQuestionComments = asyncHandler(async (req, res, next) => {
  ...
  const comments = await CommentService.listQuestionComments(
    questionId as string,
  );
...
export const listAnswerComments = asyncHandler(async (req, res, next) => {
  ...
  const comments = await CommentService.listAnswerComments(
    answerId as string,
  );
