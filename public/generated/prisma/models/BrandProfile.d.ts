...
export type GetBrandProfileAggregateType<T extends BrandProfileAggregateArgs> = {
    [P in keyof T & keyof AggregateBrandProfile]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateBrandProfile[P]> : Prisma.GetScalarType<T[P], AggregateBrandProfile[P]>;
};
...
export type GetBrandProfileGroupByPayload<T extends BrandProfileGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<BrandProfileGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof BrandProfileGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], BrandProfileGroupByOutputType[P]> : Prisma.GetScalarType<T[P], BrandProfileGroupByOutputType[P]>;
}>>;
...
export type BrandProfileScalarRelationFilter = {
    ...
    isNot?: Prisma.BrandProfileWhereInput;
};
...
export type BrandProfileCreateNestedOneWithoutProductsInput = {
    ...
    connectOrCreate?: Prisma.BrandProfileCreateOrConnectWithoutProductsInput;
...
export type BrandProfileUpsertWithoutProductsInput = {
    update: Prisma.XOR<Prisma.BrandProfileUpdateWithoutProductsInput, Prisma.BrandProfileUncheckedUpdateWithoutProductsInput>;
    create: Prisma.XOR<Prisma.BrandProfileCreateWithoutProductsInput, Prisma.BrandProfileUncheckedCreateWithoutProductsInput>;
    where?: Prisma.BrandProfileWhereInput;
};
export type BrandProfileUpdateToOneWithWhereWithoutProductsInput = {
    where?: Prisma.BrandProfileWhereInput;
    data: Prisma.XOR<Prisma.BrandProfileUpdateWithoutProductsInput, Prisma.BrandProfileUncheckedUpdateWithoutProductsInput>;
};
...
export type BrandProfileCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<BrandProfileFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BrandProfileDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['BrandProfile'];
        meta: {
            name: 'BrandProfile';
        };
    };
     ...
     * })
    **/
    count<T extends BrandProfileCountArgs>(args?: Prisma.Subset<T, BrandProfileCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], BrandProfileCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends BrandProfileGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, BrandProfileGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBrandProfileGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
 ...
 */
export type BrandProfile$productsArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
...
//# sourceMappingURL=BrandProfile.d.ts.map