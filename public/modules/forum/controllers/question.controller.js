...
import { createQuestionSchema, updateQuestionSchema, listQuestionsSchema, } from "../schema/question.schema.js";
...
export const createQuestion = asyncHandler(async (req, res, next) => {
    ...
    const question = await QuestionService.createQuestion(req.user.id, validated);
...
export const updateQuestion = asyncHandler(async (req, res, next) => {
    ...
    const question = await QuestionService.updateQuestion(req.user.id, id, validated);
...
export const deleteQuestion = asyncHandler(async (req, res, next) => {
    ...
    const result = await QuestionService.deleteQuestion(req.user.id, req.user.role, id);
